...
?> 
      ...
      <td>    <!-- BOTÃO EDITAR E EXCLUIR   -->
            ...
            <a id="bot" href="listar.php?id_up=<?php echo $dados[$i]['id'];?>">Editar</a> <!-- SE CLICAR EM EDITAR, VARIAVEL RES LINHA 20 BUSCA ESSA INFORMACAO -->

            <a id="bot" href="listar.php?id=<?php echo $dados[$i]['id'];?>">Excluir</a>
...
<?php
  ...
  {
    echo "<p id='centro'> Nao a livros cadastrados: <a href='../index.php'>Cadastrar </p> </a>";  
  }
      ...
      <form method="POST">
        ...
        <label > Editora</label>
          ...
          <?php 
                    ...
                    $dado = $p-> buscarPval();
                    $dados = $p-> buscarPuser();
                    if (count($dados)>0) //se tem retorno do banco de dados
                    {
